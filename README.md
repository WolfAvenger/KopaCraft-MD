...
|---|--------------|-----------|---------------------|
| 1 | AdvancementPlaques | Показывает достижения как красивые таблички | https://www.curseforge.com/minecraft/mc-mods/advancement-plaques |
| 2 | Alexs Delight | Добавляет новую еду и рецепты | https://www.curseforge.com/minecraft/mc-mods/alexs-delight |
| 3 | Alexs Mobs | Добавляет разнообразных новых существ | https://www.curseforge.com/minecraft/mc-mods/alexs-mobs |
| 4 | Appleskin | Показывает детальную информацию о еде | https://www.curseforge.com/minecraft/mc-mods/appleskin |
| 5 | Architectury | Библиотека API для других модов | https://www.curseforge.com/minecraft/mc-mods/architectury-api |
...
| 14 | Caelus | API для механики полёта | https://www.curseforge.com/minecraft/mc-mods/caelus |
| 15 | Carryon | Позволяет переносить блоки и существ | https://www.curseforge.com/minecraft/mc-mods/carry-on |
| 16 | Chipped | Добавляет варианты дизайна блоков | https://www.curseforge.com/minecraft/mc-mods/chipped |
| 17 | Chunk Loaders | Держит выбранные чанки загруженными | https://www.curseforge.com/minecraft/mc-mods/chunk-loaders |
| 18 | Chunk Pregenerator [♫] | Предварительно генерирует чанки мира | https://www.curseforge.com/minecraft/mc-mods/chunkpregenerator |
| 19 | Chunky [♫] | Инструмент предварительной генерации мира | https://www.curseforge.com/minecraft/mc-mods/chunky-pregenerator-forge |
| 20 | Citadel | Необходимая библиотека для Alexs Mobs | https://www.curseforge.com/minecraft/mc-mods/citadel |
| 21 | Cloth Config | API для настройки модов | https://www.curseforge.com/minecraft/mc-mods/cloth-config |
| 22 | Crabbers Delight | Добавляет морепродукты и готовку | https://www.curseforge.com/minecraft/mc-mods/crabbers-delight |
| 23 | Create | Технический мод с механизмами | https://www.curseforge.com/minecraft/mc-mods/create |
| 24 | Create Addition | Дополнение для мода Create | https://www.curseforge.com/minecraft/mc-mods/createaddition |
| 25 | Create: Deepslate Processing | перерабатывать глубинный сланец | https://www.curseforge.com/minecraft/mc-mods/create-deepslate-processing |
| 26 | Create Central Kitchen | Автоматизация еды для Create | https://www.curseforge.com/minecraft/mc-mods/create-central-kitchen |
| 27 | Create Enchantment Industry | Механика зачарования для Create | https://www.curseforge.com/minecraft/mc-mods/create-enchantment-industry |
| 28 | Create New Age | Технологическое дополнение для Create | https://www.curseforge.com/minecraft/mc-mods/create-new-age |
| 29 | Create: Ultimate Factory | Позволяет делать заводы алмазов и незерита| https://www.curseforge.com/minecraft/mc-mods/create-ultimate-factory |
| 30 | Create Wizardry | Магическое дополнение для Create | https://www.curseforge.com/minecraft/mc-mods/create-wizardry |
| 31 | Creative Core | Необходимая библиотека для модов | https://www.curseforge.com/minecraft/mc-mods/creativecore |
| 32 | CullLessLeaves [♫] | Улучшает отрисовку листвы | https://www.curseforge.com/minecraft/mc-mods/culllessleaves-reforged |
| 33 | Cupboard | Мод для хранения мебели | https://www.curseforge.com/minecraft/mc-mods/cupboard |
| 34 | Curios | Добавляет дополнительные слоты экипировки | https://www.curseforge.com/minecraft/mc-mods/curios |
| 35 | Doapi | Библиотека для анимации дверей | https://www.curseforge.com/minecraft/mc-mods/do-api |
| 36 | Dummmmmmmy [♫] | Добавляет манекен для тренировки |https://www.curseforge.com/minecraft/mc-mods/mmmmmmmmmmmm |
| 37 | Enders Delight | Кулинария в стиле Края | https://www.curseforge.com/minecraft/mc-mods/ends-delight |
